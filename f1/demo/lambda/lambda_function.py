...
def delete_iframes(driver):
    #results_archive_('Finding iFrames...')
...
def handler(event, context):
    try:
        ...
        for results_categories_link in results_categories_links:
            ...
            results_years_links_cpy = results_years_links[:5] # Only process 5 records for local demo
